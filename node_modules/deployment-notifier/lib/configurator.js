...
var env_vars_validation_schema = joi.object().required().keys({
...
exports.create = function (env) {
  var validated_env = internals.validateEnvVars(env);
  return {
    slack: {
...
internals.validateEnvVars = function (env_vars) {
  var options_to_allow_excessive_env_vars = { stripUnknown: true };
